...
#include "config/v810/v810-opts.h"
...
#endif
#ifdef GENERATOR_FILE
extern int small_memory_max[(int)SMALL_MEMORY_max];
#else
  int x_small_memory_max[(int)SMALL_MEMORY_max];
#define small_memory_max global_options.x_small_memory_max
#endif
#ifdef GENERATOR_FILE
...
#ifndef GENERATOR_FILE
  int x_VAR_msda_;
#define x_VAR_msda_ do_not_use
#endif
#ifndef GENERATOR_FILE
  int x_VAR_mzda_;
#define x_VAR_mzda_ do_not_use
#endif
#ifndef GENERATOR_FILE
...
#define MASK_BIG_SWITCH (1 << 0)
#define MASK_DEBUG (1 << 1)
#define MASK_JUMP_TABLES_IN_DATA_SECTION (1 << 2)
#define MASK_PROLOG_FUNCTION (1 << 3)
#define MASK_V810 (1 << 4)

#define TARGET_BIG_SWITCH ((target_flags & MASK_BIG_SWITCH) != 0)
#define TARGET_DEBUG ((target_flags & MASK_DEBUG) != 0)
#define TARGET_JUMP_TABLES_IN_DATA_SECTION ((target_flags & MASK_JUMP_TABLES_IN_DATA_SECTION) != 0)
#define TARGET_PROLOG_FUNCTION ((target_flags & MASK_PROLOG_FUNCTION) != 0)
#define TARGET_V810 ((target_flags & MASK_V810) != 0)
...
enum opt_code
{
  ...
  OPT_mbig_switch = 986,                     /* -mbig-switch */
  OPT_mdebug = 987,                          /* -mdebug */
  OPT_mjump_tables_in_data_section = 988,    /* -mjump-tables-in-data-section */
  OPT_mprolog_function = 989,                /* -mprolog-function */
  /* OPT_msda_ = 990, */                     /* -msda- */
  OPT_msda_ = 991,                           /* -msda= */
  OPT_mv810 = 992,                           /* -mv810 */
  /* OPT_mzda_ = 993, */                     /* -mzda- */
  OPT_mzda_ = 994,                           /* -mzda= */
  OPT_n = 995,                               /* -n */
  OPT_no_canonical_prefixes = 996,           /* -no-canonical-prefixes */
  OPT_no_integrated_cpp = 997,               /* -no-integrated-cpp */
  OPT_nocpp = 998,                           /* -nocpp */
  OPT_nodefaultlibs = 999,                   /* -nodefaultlibs */
  OPT_nostartfiles = 1000,                   /* -nostartfiles */
  OPT_nostdinc = 1001,                       /* -nostdinc */
  OPT_nostdinc__ = 1002,                     /* -nostdinc++ */
  OPT_nostdlib = 1003,                       /* -nostdlib */
  OPT_o = 1004,                              /* -o */
  OPT_p = 1005,                              /* -p */
  OPT_pass_exit_codes = 1006,                /* -pass-exit-codes */
  OPT_pedantic = 1007,                       /* -pedantic */
  OPT_pedantic_errors = 1008,                /* -pedantic-errors */
  OPT_pg = 1009,                             /* -pg */
  OPT_pie = 1010,                            /* -pie */
  OPT_pipe = 1011,                           /* -pipe */
  OPT_print_file_name_ = 1012,               /* -print-file-name= */
  OPT_print_libgcc_file_name = 1013,         /* -print-libgcc-file-name */
  OPT_print_multi_directory = 1014,          /* -print-multi-directory */
  OPT_print_multi_lib = 1015,                /* -print-multi-lib */
  OPT_print_multi_os_directory = 1016,       /* -print-multi-os-directory */
  OPT_print_multiarch = 1017,                /* -print-multiarch */
